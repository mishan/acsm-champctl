...
describe("dragging a round", () => {
  ...
  it("ignores a cancel belonging to some other pointer", async () => {
    // A second finger landing on the screen and lifting again fires
    // pointercancel with its own id. Without the guard that abandons a drag it
    // has nothing to do with, and the row snaps back while the finger holding
    // it is still down.
    await twoRounds()
